...
import cv2
import time
cap = cv2.VideoCapture('apps/assets/video/suspens.mp4')  #Path to footage
car_cascade = cv2.CascadeClassifier('apps/packages/hand.xml') 
...
while True:
    ...
    video_cap = cv2.VideoWriter("apps/assets/img/" + dt +".jpg", fourcc,20.0,(640,480))
